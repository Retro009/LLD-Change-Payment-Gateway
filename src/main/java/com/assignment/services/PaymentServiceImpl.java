...
public class PaymentServiceImpl implements PaymentService{
    ...
    public Payment makePayment(long billId) throws InvalidBillException {
        Bill bill = billRepository.findById(billId).orElseThrow(() -> new InvalidBillException("Invalid bill id"));
        return  paymentGatewayAdapter.makePayment(bill.getId(),bill.getAmountToBePaid());
    }
}
